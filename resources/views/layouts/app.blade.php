    ...
    <div class="wrapper">
        ...
        <aside class="left-sidebar sidebar-dark" id="left-sidebar">
            <div id="sidebar" class="sidebar sidebar-with-footer">
                ...
                <div class="app-brand">
                    <a href="/index.html">
                        <img src="assets/images/4.png" alt="Mono">
                    </a>
                </div>
                ...
                <div class="sidebar-left" data-simplebar style="height: 100%;">
                    ...
                    <ul class="nav sidebar-inner" id="sidebar-menu">
                        ...
                        <li>
                            <a class="sidenav-item-link" href="{{ url('fournisseur') }}">
                                <i class="mdi mdi-account"></i>
                                <span class="nav-text">Founisseur</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="sidenav-item-link" href="{{url('produit')}}">
                        ...
                        <li>
                            <a class="sidenav-item-link" href="{{url('laratrust')}}">
                                <i class="mdi mdi-cart-plus"></i>
                                <span class="nav-text">Vente</span>
                            </a>
                        </li>
                        ...
                        <li class="has-sub">
                            <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse"
                                ...
                                <span class="nav-text">Notchpay</span> <b class="caret"></b>
                            </a>
                        ...
                        <ul class="nav navbar-nav">
                                            ...
                                            <div class="tab-pane fade show active" id="all" role="tabpanel"
                                                ...
                                                <div class="media media-sm bg-warning-10 p-4 mb-0">
                                                    ...
                                                    <div class="media-body">
                                                        <a href="user-profile.html">
                                                            <span class="title mb-0">Mariette</span>
                                                            <span class="discribe">Extremity sweetness difficult
                                                                behaviour he of. On disposal of as
                                                                landlord horrible. Afraid at highly months do things on
                                                                at.</span>
                                                            <span class="time">
                                                                <time>Just now</time>...
                                                            </span>
                                                    ...
                                                    <div class="media-body">
                                                        <a href="user-profile.html">
                                                            ...
                                                            <span class="discribe"> Beatae quia natus assumenda
                                                                laboriosam, nisi perferendis aliquid
                            ...
                            <li class="dropdown user-menu">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li>
                                        <a class="dropdown-link-item" href="{{url('profile')}}" style="background-size: cover">
                                            <i class="mdi mdi-account-outline"></i>
                                            <span class="nav-text">Prifile</span>
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li class="dropdown-footer">
                                        ...
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <button class="btn btn-foreground-alternate p-0">
                                                <i class="mdi mdi-logout"></i> Deconnexion
                                            </button>
                                        </form>
