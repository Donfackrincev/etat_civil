                ...
                <div class="page-title-container">
                    <div class="row">
                        <div class="col-12 col-md-7">
                            <h1 class="mb-0 pb-0 display-4" id="title">Detail sur une publication</h1>
                            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                                <ul class="breadcrumb pt-0">
                                    <li class="breadcrumb-item"><a href="Dashboards.Default.html">Dashbord</a></li>
                                    <li class="breadcrumb-item"><a href="Interface.html">publication</a></li>
                    ...
                    <div>
                        <table id="datatableBoxed" class="data-table nowrap hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="col">montant_verser</td>
                                ...
                                <tr>
                                    <form method="POST" action="{{ url('/publication/delete/' . $publication->id)}}">
                                        {{method_field('DELETE')}}
                                        @csrf
