                ...
                <div class="menu-container flex-grow-1">
                    <ul id="menu" class="menu">
                                ...
                                <ul id="apps">
                                    ...
                                    <li>
                                        <a href="{{ url('employer/create') }}">
                                            <span class="label">Ajouter un employer</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('employer') }}">
                                            <span class="label">Liste des employer</span>
                                        </a>
                                    </li>
                        ...
                        <li>
                            <a href="#blocks" data-href="Blocks.html">
                                <i data-acorn-icon="grid-5" class="icon" data-acorn-size="18"></i>
                                <span class="label">Acte deces</span>
                            </a>
                            <ul id="blocks">

                                <li>
                                    <a href="{{ url('declarationdeces') }}">
                                        <span class="label">Liste des declarations</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ url('deces') }}">
                                        <span class="label">Liste des actes de deces</span>
                                    </a>
                                </li>
                        ...
                        <li>
                            <a href="#apps" data-href="Apps.html">
                                <i data-acorn-icon="screen" class="icon" data-acorn-size="18"></i>
                                <span class="label">Acte naissance</span>
                            </a>
                            <ul id="apps">
                                <li>
                                    <a href="{{ url('declaration/create') }}">
                                        <span class="label">Ajouter une declaration</span>
                                    </a>
                                </li>

                                <li>
                                    <a href="{{ url('declaration') }}">
                                        <span class="label">liste des declaration</span>
                                    </a>
                                </li>

                                <li>
                                    <a href="{{ url('naissance') }}">
                                        <span class="label">liste des actes de naidssance</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ url('naissance/create') }}">
                                        <span class="label">Ajouter un acte </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ url('temoinage') }}">
                                        <span class="label">Liste des temoin </span>
                                    </a>
                                </li>

                                <li>
                                    <a href="{{ url('temoinage/create') }}">
                                        <span class="label">Ajouter un temoin </span>
                                    </a>
                                </li>
