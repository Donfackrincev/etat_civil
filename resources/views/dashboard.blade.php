            ...
            <div class="row">
                            ...
                            <div class="card-body">
                                <div
                                    ...
                                    <div class="d-flex flex-column">
                                        <span class="h3 text-white">Quantiter en stock</span>
                                        <span class="h3 text-white">{{ $produits }}</span>
                                    </div>
                                    <div>
                                        <span>45%</span>
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div
                                class="bg-success d-flex justify-content-between flex-wrap p-5 text-white align-items-lg-end">
                                <div class="d-flex flex-column">
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div
                                class="bg-danger d-flex justify-content-between flex-wrap p-5 text-white align-items-lg-end">
                                <div class="d-flex flex-column">
