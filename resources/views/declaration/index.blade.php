                        ...
                        <table id="datatableRowsServerSide" class="data-table nowrap hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-muted text-small text-uppercase">Nom_per</th>
                                    <th class="text-muted text-small text-uppercase">Nom_mere</th>
                                    <th class="text-muted text-small text-uppercase">Medecin_declarant</th>
