                ...
                <div class="page-title-container">
                    <div class="row">
                        <div class="col-12 col-md-7">
                            <h1 class="mb-0 pb-0 display-4" id="title">Detail sur une declaration</h1>
                            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                                <ul class="breadcrumb pt-0">
                                    <li class="breadcrumb-item"><a href="Dashboards.Default.html">Dashbord</a></li>
                                    <li class="breadcrumb-item"><a href="Interface.html">declaration</a></li>
                    ...
                    <div>
                        <table id="datatableBoxed" class="data-table nowrap hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="col">Nom</th>
                                    <td>{{ ($declaration->personne->nom)}}</td>
                                </tr>

                                <tr>
                                    <th scope="col">Prenom</th>
                                    <td>{{ ($declaration->personne->prenom)}}</td>
                                </tr>

                                <tr>
                                    <th scope="col">date_naissance</th>
                                    <td>{{ ($declaration->personne->date_naissance)}}</td>
                                </tr>

                                <tr>
                                    <th scope="col">Nom_pere</th>
                                    <td>{{ ($declaration->personne->nom_pere)}}</td>
                                </tr>

                                <tr>
                                    <th scope="col">Nom_mere</th>
                                    <td>{{ ($declaration->personne->nom_mere)}}</td>
                                </tr>

                                <tr>
                                    <th scope="col">motif_deces</th>
                                    <td>{{ ($declaration->motif_deces)}}</td>

                                </tr>
                                <tr>
                                    <th scope="col">lieu_deces</th>
                                    <td>{{ ($declaration->lieu_deces)}}</td>

                                </tr>
                                <tr>
                                    <th scope="col">Medecin_declarant</th>
                                    <td>{{ ($declaration->medecin->fontion)}}</td>

                                </tr>
                               
                               
                                <tr>
                                    <form method="POST" action="{{ url('/declaration/delete/' . $declaration->id)}}">
                                        {{method_field('DELETE')}}
                                        @csrf
