                ...
                <div class="card-body">
                    ...
                    <template class="custom-legend-item">
                        <a href="#" class="d-flex flex-row g-0 align-items-center me-5">
                            <div class="pe-2">
                                <div
                                    class="icon-container border sh-5 sw-5 rounded-xl d-flex justify-content-center align-items-center">
                                    <i class="icon"></i>
                                </div>
                            </div>
                            <div>
                ...
                <div class="scroll-by-count" data-count="8">
                    ...
                    <div class="card mb-2 sh-10 sh-md-8">
                        <div class="card-body pt-0 pb-0 h-100">
                            <div class="row g-0 h-100 align-content-center">
                                <div class="col-12 col-md-5 d-flex align-items-center mb-2 mb-md-0">
                                    <a href="Pages.Portfolio.Detail.html" class="body-link text-truncate">Cheesymite
                                        Scroll</a>
                                </div>
                                <div class="col-4 col-md-2 d-flex align-items-center text-muted text-medium mb-1 mb-md-0">
                                    <span class="badge bg-outline-tertiary me-1">STOCK</span>
                            ...
                            <div class="row g-0 h-100 align-content-center">
                                <div class="col-12 col-md-5 d-flex align-items-center mb-2 mb-md-0">
                                    <a href="Pages.Portfolio.Detail.html"
                                        class="body-link text-truncate">Ruisreikäleipä</a>
                                </div>
                                <div class="col-4 col-md-2 d-flex align-items-center text-muted text-medium mb-1 mb-md-0">
                                    <span class="badge bg-outline-primary me-1">SALE</span>
                                </div>
                    ...
                    <div class="card mb-2 sh-10 sh-md-8">
                        <div class="card-body pt-0 pb-0 h-100">
                            <div class="row g-0 h-100 align-content-center">
                                <div class="col-12 col-md-5 d-flex align-items-center mb-2 mb-md-0">
                                    <a href="Pages.Portfolio.Detail.html" class="body-link text-truncate">Buccellato di
                                        Lucca</a>
                                </div>
                                <div class="col-4 col-md-2 d-flex align-items-center text-muted text-medium mb-1 mb-md-0">
                    ...
                    <div class="card sh-13">
                        <div class="card-body py-0 d-flex">
                            <div class="row g-0 d-flex w-100 align-items-center">
                                <div class="col sh-6 d-flex flex-column justify-content-center custom-legend-container">
                                </div>
                                <template class="custom-legend-item">
                            ...
                            <div class="card sh-11 hover-scale-up cursor-pointer">
                                <div class="h-100 row g-0 card-body align-items-center py-3">
                                    ...
                                    <div class="col">
                                        <div class="row gx-2 d-flex align-content-center">
                                            <div class="col-12 col-xl d-flex">
                                                <div class="d-flex align-items-center lh-1-25">Shipped Orders
                                                </div>
                                            </div>
                                            <div class="col-12 col-xl-auto">
                                                <div class="cta-2 text-primary">22</div>
                            ...
                            <div class="card sh-11 hover-scale-up cursor-pointer">
                                <div class="h-100 row g-0 card-body align-items-center py-3">
                                    ...
                                    <div class="col">
                                        <div class="row gx-2 d-flex align-content-center">
                                            <div class="col-12 col-xl d-flex">
                                                <div class="d-flex align-items-center lh-1-25">Delivered Orders
                                                </div>
                                            </div>
                                            <div class="col-12 col-xl-auto">
                                                <div class="cta-2 text-primary">35</div>
                            ...
                            <div class="card sh-11 hover-scale-up cursor-pointer">
                                <div class="h-100 row g-0 card-body align-items-center py-3">
                                    ...
                                    <div class="col">
                                        <div class="row gx-2 d-flex align-content-center">
                                            <div class="col-12 col-xl d-flex">
                                                <div class="d-flex align-items-center lh-1-25">Pending Orders
                                                </div>
                                            </div>
                                            <div class="col-12 col-xl-auto">
                                                <div class="cta-2 text-primary">14</div>
                            ...
                            <div class="card sh-11 hover-scale-up cursor-pointer">
                                <div class="h-100 row g-0 card-body align-items-center py-3">
                                    ...
                                    <div class="col">
                                        <div class="row gx-2 d-flex align-content-center">
                                            <div class="col-12 col-xl d-flex">
                                                <div class="d-flex align-items-center lh-1-25">Unconfirmed
                                                    Orders</div>
                                            </div>
                                            <div class="col-12 col-xl-auto">
                                                <div class="cta-2 text-primary">3</div>
                    ...
                    <div class="card-body">
                        ...
                        <template class="custom-legend-item">
                            <a href="#" class="d-flex flex-row g-0 align-items-center me-5">
                                ...
                                <div>
                                    <div class="text p mb-0 d-flex align-items-center text-small text-muted">
                                        Title</div>
                                    <div class="value cta-4">Value</div>
                                </div>
                            </a>
                        ...
                        <div class="card mb-2 sh-10 sh-md-8">
                            <div class="card-body pt-0 pb-0 h-100">
                                <div class="row g-0 h-100 align-content-center">
                                    ...
                                    <div
                                        class="col-4 col-md-2 d-flex align-items-center text-muted text-medium mb-1 mb-md-0">
                                        <span class="badge bg-outline-tertiary me-1">STOCK</span>
                                    </div>
                                    <div
                                        class="col-4 col-md-3 d-flex align-items-center text-medium text-danger justify-content-center">
                        ...
                        <div class="card mb-2 sh-10 sh-md-8">
                            <div class="card-body pt-0 pb-0 h-100">
                                <div class="row g-0 h-100 align-content-center">
                                    <div class="col-12 col-md-5 d-flex align-items-center mb-2 mb-md-0">
                                        <a href="Pages.Portfolio.Detail.html"
                                            class="body-link text-truncate">Cheesymite Scroll</a>
                                    </div>
                                    <div
                                        class="col-4 col-md-2 d-flex align-items-center text-muted text-medium mb-1 mb-md-0">
                                        <span class="badge bg-outline-tertiary me-1">STOCK</span>
                        ...
                        <div class="card mb-2 sh-10 sh-md-8">
                            <div class="card-body pt-0 pb-0 h-100">
                                <div class="row g-0 h-100 align-content-center">
                                    <div class="col-12 col-md-5 d-flex align-items-center mb-2 mb-md-0">
                                        <a href="Pages.Portfolio.Detail.html"
                                            class="body-link text-truncate">Bagel</a>
                                    </div>
                                    <div
                                        class="col-4 col-md-2 d-flex align-items-center text-muted text-medium mb-1 mb-md-0">
                                        <span class="badge bg-outline-tertiary me-1">STOCK</span>
                        ...
                        <div class="card mb-2 sh-10 sh-md-8">
                            <div class="card-body pt-0 pb-0 h-100">
                                <div class="row g-0 h-100 align-content-center">
                                    <div class="col-12 col-md-5 d-flex align-items-center mb-2 mb-md-0">
                                        <a href="Pages.Portfolio.Detail.html"
                                            class="body-link text-truncate">Buccellato di Lucca</a>
                                    </div>
                                    <div
                                        class="col-4 col-md-2 d-flex align-items-center text-muted text-medium mb-1 mb-md-0">
                                        <span class="badge bg-outline-secondary me-1">TREND</span>
                        ...
                        <div class="card mb-2 sh-10 sh-md-8">
                            <div class="card-body pt-0 pb-0 h-100">
                                <div class="row g-0 h-100 align-content-center">
                                    <div class="col-12 col-md-5 d-flex align-items-center mb-2 mb-md-0">
                                        <a href="Pages.Portfolio.Detail.html"
                                            class="body-link text-truncate">Pullman Loaf</a>
                                    </div>
                                    <div
                                        class="col-4 col-md-2 d-flex align-items-center text-muted text-medium mb-1 mb-md-0">
                                        <span class="badge bg-outline-secondary me-1">TREND</span>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card sh-13">
                            <div class="card-body py-0 d-flex">
                                <div class="row g-0 d-flex w-100 align-items-center">
                                    <div
                                        class="col sh-6 d-flex flex-column justify-content-center custom-legend-container">
                                    </div>
                                    <template class="custom-legend-item">
                                        <div class="text-small text-muted text mt-2"></div>
                                        <div class="cta-3 text-primary value"></div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card sh-13">
                            <div class="card-body py-0 d-flex">
                                <div class="row g-0 d-flex w-100 align-items-center">
                                    <div
                                        class="col sh-7 d-flex flex-column justify-content-center custom-legend-container">
                                    </div>
                                    <template class="custom-legend-item">
                                        <div class="text-small text-muted text mt-2"></div>
                                        <div class="cta-3 text-primary value"></div>
                                ...
                                <div class="row g-0 d-flex w-100 align-items-center">
                                    <div class="col d-flex flex-column justify-content-center">
                                        <div class="custom-tooltip">
                                            ...
                                            <i class="icon d-inline-block align-middle me-1 text-primary"
                                                data-acorn-size="15"></i>
                                            <div class="cta-4 text-primary value d-inline-block align-middle">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-auto">
