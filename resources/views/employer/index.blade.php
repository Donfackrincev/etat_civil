                ...
                <div class="page-title-container">
                    <div class="row">
                        <div class="col-12 col-md-7">
                            <h1 class="mb-0 pb-0 display-4" id="title">Liste des employers</h1>
                        ...
                        <table id="datatableRowsServerSide" class="data-table nowrap hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-muted text-small text-uppercase">Poste</th>
                                    <th class="text-muted text-small text-uppercase">Prise de fonction</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $employer->date_prise_foncton}}</td>
                                    <td>{{ ($employer->personne->nom)}}</td>
                                    <td>{{ ($employer->personne->prenom)}}</td>
                                    <td>{{ ($employer->personne->date_naissance)}}</td>
                                    <td>{{ ($employer->personne->sexe)}}</td>
                                    <td>{{ $employer->commune->nom_commune}}</td>
                                    <td>

                                        <form method="POST" action="{{ url('/employer/delete/' . $employer->id)}}">
                                            {{method_field('DELETE')}}
                                            @csrf

                                            @if(Auth::User()->hasPermission('employers-show'))
                                            <a href="{{url('employer/' .$employer->id)}}">
                                                <button class="btn btn-info mb-1" type="button"> <i class="fa fa-eye"></i></button>
                                            </a>
                                            @endif

                                            @if(Auth::User()->hasPermission('employers-update'))
