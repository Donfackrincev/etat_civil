                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="{{ url('commune') }}" novalidate="novalidate">
                                            @csrf
                                            <div class="modal-body">
                                                <form method="POST" action="{{ url('commune') }}" id="validationTopLabel"
                                                    class="tooltip-end-top" novalidate="novalidate">
                                                    @csrf

                                                    <label class="mb-3 top-label">
                                                        <input class="form-control" type="text" name="nom_commune"
                                                            required="">
                                                    ...
                                                    <label class="mb-3 top-label">
                                                        <input class="form-control" type="text" name="arrondissement"
                                                            required="">
                                    ...
                                    @foreach ($commune as $commune)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="POST"
                                                    action="{{ url('/commune/delete/' . $commune->id) }}">
                                                    {{ method_field('DELETE') }}
                                                    @csrf
