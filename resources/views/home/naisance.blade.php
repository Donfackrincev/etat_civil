...
<head>
    ...
    <!-- Favicon -->
    <link href="{{asset('acceuil/img/favicon.ico')}}" rel="icon">
    ...
    <link href="{{asset('acceuil/css/style.css')}}" rel="stylesheet">
...
<body>
    ...
    <script src="{{asset('acceuil/lib/counterup/counterup.min.js')}}"></script>
